...
const Hero = () => {
    return (
        <div className='hero'>
            ...
            <p className='text-gray-400 text-base lg:text-2xl'>I am a <b>Frontend Developer</b> who enjoys creating thing that lives on the internet. Helping people to turn their requirement into live web applications</p>
