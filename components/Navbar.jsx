...
const Navbar = () => {
    ...
    return (
        <div>
            <div className='w-[100%] h-16 border-b px-5 md:h-[100vh] md:w-16 md:border-r border-gray-600 fixed top-0 left-0 flex md:flex-col justify-between items-center md:py-5 md:px-0 bg-slate-900'>
